...
export default function RatingModal({ isOpen, onClose, appLanguage = 'ar' }: RatingModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-[#3A3A3A]/40 backdrop-blur-xs flex items-center justify-center p-4 z-50 font-sans" dir={langInfo.dir}>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-[#5A5A40]">
                  {t.rateAppFeedbackLabel}
                </label>
                <textarea
                  value={feedback}
                  onChange={(e) => setFeedback(e.target.value)}
                  placeholder={t.rateAppPlaceholder}
                  rows={3}
